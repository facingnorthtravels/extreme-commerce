...
const services=[
  ...
  {tag:"HIRE TALENT",title:"Virtual Assistants",description:"Trained Amazon VAs â€” full-time or part-time â€” ready to run your account.",href:"#services",icon:Users,span:"lg:col-span-2",variant:"yellow"},
  ...
  return(
    <section id="services" className="relative bg-white py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <SectionHeading eyebrow="WHAT WE DO" title={<>Six ways we build<br/>your Amazon business.</>} subtitle="From done-for-you launches to trained virtual assistants â€” pick your level of involvement."/>
