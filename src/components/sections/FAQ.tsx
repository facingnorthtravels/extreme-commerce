...
const faqs=[{q:"Who is the Elite Program for?",a:"Entrepreneurs, investors, and business owners with capital they want to deploy into a real Amazon business. It's not for beginners looking to learn â€” it's for operators ready to launch."},{q:"How much capital do I need to commit?",a:"We allocate $7,000 per launch, with three launches over 18 months. That's in addition to your share of cost of goods and reinvestment into winners."},{q:"How does the 80/20 profit share work?",a:"You keep 80% of the profit; we retain 20%. Our share is structured to unlock at ROI milestones â€” we earn 10% once ROI crosses 50%, and 20% once ROI crosses 100%."},{q:"What if a product doesn't work?",a:"We build testing into the model. Not every launch succeeds. We retire losers quickly, document the lesson, and push winners aggressively. Three launches gives us a portfolio, not a single bet."},{q:"Can I hire just a virtual assistant instead?",a:"Yes. Our VA service is separate and flexible â€” full-time or part-time, trained on Amazon operations, and placed inside your existing setup."},{q:"Do you operate outside of Amazon?",a:"Yes. We also launch and operate on Walmart, TikTok Shop, Etsy, and Amazon Wholesale. Your strategy will match your product and market, not a single platform."}];
export function FAQ(){
