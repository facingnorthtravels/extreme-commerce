...
const testimonials=[{quote:"We deployed capital, they deployed a team. Six months in, we're three products deep and profitable on two of them.",name:"Ahmed R.",role:"Investor Â· Dubai",accent:"navy"},{quote:"The weekly reporting alone is worth it. I finally understand what's actually happening inside my Amazon business.",name:"Maria K.",role:"Founder Â· UK",accent:"yellow"},{quote:"Zero fluff. Practical, outcome-driven, and they don't waste time. We went from idea to live listing in under 12 weeks.",name:"James O.",role:"Business Owner Â· USA",accent:"azure"},{quote:"They've already done what I was trying to learn. Skipping the 2-year learning curve alone paid for itself.",name:"Saba F.",role:"Entrepreneur Â· Canada",accent:"navy"}];
